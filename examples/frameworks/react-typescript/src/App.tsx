import {type Element3D, type XYZNumberValuesPropertyFunction, defineElements} from 'lume'
		...
		<>
			<lume-scene webgl environment={lunaStation}>
				<lume-element3d align-point="0.5 0.5 0.5">
					<lume-camera-rig vertical-angle="30" min-distance="0.4" max-distance="2" dolly-speed="0.002" distance="1">
						<lume-perspective-camera active={this.state.view === 'free'} near="0.14" far="60" slot="camera-child" />
					</lume-camera-rig>

					<lume-element3d rotation={[this.state.view === 'top' ? -90 : 0, 0, 0]}>
						<lume-perspective-camera active={this.state.view !== 'free'} position="0 0 0.7" near="0.14" />
					</lume-element3d>
				</lume-element3d>
				...
				>
					<lume-basic-material texture={lunaStation} sidedness="double" />
				</lume-sphere>
			</lume-scene>
