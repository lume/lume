...
export class App extends Component<{}, State> {
	...
	render = () => (
		<>
			<lume-scene webgl environment={lunaStation}>
				...
				/>
				{/* >
					<lume-perspective-camera slot="camera-child" active near="0.1" far="60"></lume-perspective-camera>
				</lume-camera-rig> */}
	...
	componentDidMount() {
		// This is no longer needed in React 19, should be able to pass it in via JSX.
