...
let FlickeringOrbs = (() => {
    ...
    var FlickeringOrbs = class extends _classSuper {
        ...
        shadowBias = (__runInitializers(this, _instanceExtraInitializers), __runInitializers(this, _shadowBias_initializers, 0));
        ...
        color = __runInitializers(this, _color_initializers, null
        // prettier-ignore
        );
        // prettier-ignore
        template = () => html `
