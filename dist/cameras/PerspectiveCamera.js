...
let PerspectiveCamera = (() => {
    ...
    let ___updateProjection_decorators;
    let ___updateAspect_decorators;
    let ___updateNear_decorators;
    let ___updateFar_decorators;
    let ___updateZoom_decorators;
    var PerspectiveCamera = class extends _classSuper {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
            _fov_decorators = [numberAttribute];
            ___updateProjection_decorators = [effect];
            ___updateAspect_decorators = [effect];
            ___updateNear_decorators = [effect];
            ___updateFar_decorators = [effect];
            ___updateZoom_decorators = [effect];
            __esDecorate(this, null, ___updateProjection_decorators, { kind: "method", name: "__updateProjection", static: false, private: false, access: { has: obj => "__updateProjection" in obj, get: obj => obj.__updateProjection }, metadata: _metadata }, null, _instanceExtraInitializers);
            __esDecorate(this, null, ___updateAspect_decorators, { kind: "method", name: "__updateAspect", static: false, private: false, access: { has: obj => "__updateAspect" in obj, get: obj => obj.__updateAspect }, metadata: _metadata }, null, _instanceExtraInitializers);
            __esDecorate(this, null, ___updateNear_decorators, { kind: "method", name: "__updateNear", static: false, private: false, access: { has: obj => "__updateNear" in obj, get: obj => obj.__updateNear }, metadata: _metadata }, null, _instanceExtraInitializers);
            __esDecorate(this, null, ___updateFar_decorators, { kind: "method", name: "__updateFar", static: false, private: false, access: { has: obj => "__updateFar" in obj, get: obj => obj.__updateFar }, metadata: _metadata }, null, _instanceExtraInitializers);
            __esDecorate(this, null, ___updateZoom_decorators, { kind: "method", name: "__updateZoom", static: false, private: false, access: { has: obj => "__updateZoom" in obj, get: obj => obj.__updateZoom }, metadata: _metadata }, null, _instanceExtraInitializers);
