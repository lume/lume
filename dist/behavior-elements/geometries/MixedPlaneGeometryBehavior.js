 ...
 * @element mixedplane-geometry
 */
let MixedPlaneGeometryBehavior = (() => {
    let _classDecorators = [element('mixedplane-geometry', autoDefineElements)];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    let _classSuper = GeometryBehavior;
    var MixedPlaneGeometryBehavior = class extends _classSuper {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
            __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
            MixedPlaneGeometryBehavior = _classThis = _classDescriptor.value;
        ...
        _createComponent() {
            ...
            return new BoxGeometry(this.parentElement.calculatedSize.x, this.parentElement.calculatedSize.y, 1);
        }
    };
    return MixedPlaneGeometryBehavior = _classThis;
})();
export { MixedPlaneGeometryBehavior };
