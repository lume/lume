...
let RoundedRectangleGeometryBehavior = (() => {
    ...
    var RoundedRectangleGeometryBehavior = class extends _classSuper {
        ...
        _createComponent() {
            ...
            let geom;
            const roundedRectShape = new RoundedRectShape(0, 0, this.parentElement.calculatedSize.x, this.parentElement.calculatedSize.y, this.cornerRadius, this.quadraticCorners);
            if (thickness > 0) {
            ...
            geom.translate(-this.parentElement.calculatedSize.x / 2, -this.parentElement.calculatedSize.y / 2, -thickness / 2);
            return geom;
        }
    };
