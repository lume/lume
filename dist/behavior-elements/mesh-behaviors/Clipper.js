 ...
 */
let Clipper = (() => {
    let _classDecorators = [element('lume-clipper', autoDefineElements)];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    let _classSuper = MeshBehaviorEl;
    ...
    var Clipper = class extends _classSuper {
        ...
        static {
            ...
            Clipper = _classThis = _classDescriptor.value;
        ...
        set clipPlanes(value) {
            ...
            for (const v of array) {
                ...
                let root = this.composedParent.getRootNode();
        ...
        _parentDefinedEffect(parent = this.composedParent) {
            ...
            if (!refCount)
                parent.scene.localClipping = true;
            refCount++;
            ...
            createEffect(() => {
                ...
                if (!clipPlanes.length || clipDisabled)
                    return;
                const skip = this;
            ...
            onCleanup(() => {
                ...
                refCount--;
                if (!refCount)
                    this.#lastScene.localClipping = false;
                this.#lastScene = null;
            });
        }
    };
    return Clipper = _classThis;
})();
export { Clipper };
