...
let StandardMaterial = (() => {
    let _classDecorators = [element('lume-standard-material', autoDefineElements)];
    ...
    var StandardMaterial = class extends _classSuper {
        ...
        static {
            ...
            _metalness_decorators = [numberAttribute];
            _metalnessMap_decorators = [stringAttribute];
            _roughness_decorators = [numberAttribute];
            _roughnessMap_decorators = [stringAttribute];
            _vertexTangents_decorators = [booleanAttribute];
            _morphTargets_decorators = [booleanAttribute];
            _morphNormals_decorators = [booleanAttribute];
            ...
            StandardMaterial = _classThis = _classDescriptor.value;
    ...
    return StandardMaterial = _classThis;
})();
