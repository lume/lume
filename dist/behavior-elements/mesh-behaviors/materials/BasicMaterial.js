 ...
 */
let BasicMaterial = (() => {
    let _classDecorators = [element('lume-basic-material', autoDefineElements)];
    ...
    var BasicMaterial = class extends _classSuper {
        ...
        static {
            ...
            BasicMaterial = _classThis = _classDescriptor.value;
    ...
    return BasicMaterial = _classThis;
})();
