...
import { numberAttribute, stringAttribute, booleanAttribute, element } from '@lume/element';
import { MaterialBehaviorEl } from './MaterialBehaviorEl.js';
 ...
 */
let PhongMaterial = (() => {
    let _classDecorators = [element('lume-phong-material', autoDefineElements)];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    let _classSuper = MaterialBehaviorEl;
    ...
    var PhongMaterial = class extends _classSuper {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
            _alphaMap_decorators = [stringAttribute];
            _aoMap_decorators = [stringAttribute];
            _aoMapIntensity_decorators = [numberAttribute];
            _bumpMap_decorators = [stringAttribute];
            _bumpScale_decorators = [numberAttribute];
            _displacementMap_decorators = [stringAttribute];
            _displacementScale_decorators = [numberAttribute];
            _displacementBias_decorators = [numberAttribute];
            _emissiveMap_decorators = [stringAttribute];
            _get_emissive_decorators = [stringAttribute];
            _set_emissive_decorators = [stringAttribute];
            _emissiveIntensity_decorators = [numberAttribute];
            _envMap_decorators = [stringAttribute];
            _flatShading_decorators = [booleanAttribute];
            _lightMap_decorators = [stringAttribute];
            _lightMapIntensity_decorators = [numberAttribute];
            _texture_decorators = [stringAttribute];
            _normalMap_decorators = [stringAttribute];
            _normalScale_decorators = [numberAttribute];
            _reflectivity_decorators = [numberAttribute];
            _specularMap_decorators = [stringAttribute];
            _get_specular_decorators = [stringAttribute];
            _set_specular_decorators = [stringAttribute];
            _shininess_decorators = [numberAttribute];
            ...
            PhongMaterial = _classThis = _classDescriptor.value;
    ...
    return PhongMaterial = _classThis;
})();
