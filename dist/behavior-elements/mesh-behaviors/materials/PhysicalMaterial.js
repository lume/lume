...
let PhysicalMaterial = (() => {
    let _classDecorators = [element('lume-physical-material', autoDefineElements)];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    let _classSuper = StandardMaterial;
    ...
    var PhysicalMaterial = class extends _classSuper {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
            _clearcoat_decorators = [numberAttribute];
            _clearcoatRoughness_decorators = [numberAttribute];
            _refractiveIndex_decorators = [numberAttribute];
            _reflectivity_decorators = [numberAttribute];
            _transmission_decorators = [numberAttribute];
            _transmissionMap_decorators = [stringAttribute];
            ...
            PhysicalMaterial = _classThis = _classDescriptor.value;
    ...
    return PhysicalMaterial = _classThis;
})();
