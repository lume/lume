...
import { attribute, stringAttribute, element } from '@lume/element';
 ...
 */
let ShaderMaterial = (() => {
    let _classDecorators = [element('lume-shader-material', autoDefineElements)];
    ...
    var ShaderMaterial = class extends _classSuper {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
            _get_uniforms_decorators = [attribute];
            _set_uniforms_decorators = [attribute];
            _vertexShader_decorators = [stringAttribute];
            _fragmentShader_decorators = [stringAttribute];
            ...
            ShaderMaterial = _classThis = _classDescriptor.value;
    ...
    return ShaderMaterial = _classThis;
})();
