 ...
 * @element lume-mixedplane-material
 */
let MixedplaneMaterial = (() => {
    let _classDecorators = [element('lume-mixedplane-material', autoDefineElements)];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    let _classSuper = PhysicalMaterial;
    var MixedplaneMaterial = class extends _classSuper {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
            __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
            MixedplaneMaterial = _classThis = _classDescriptor.value;
    ...
    return MixedplaneMaterial = _classThis;
})();
export { MixedplaneMaterial };
//# sourceMappingURL=MixedplaneMaterial.js.map