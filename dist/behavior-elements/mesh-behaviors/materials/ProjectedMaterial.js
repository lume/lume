...
let ProjectedMaterial = (() => {
    let _classDecorators = [element('lume-projected-material', autoDefineElements)];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    let _classSuper = PhysicalMaterial;
    ...
    var ProjectedMaterial = class extends _classSuper {
        ...
        static {
            ...
            ProjectedMaterial = _classThis = _classDescriptor.value;
        ...
        _parentDefinedEffect(parent = this.composedParent) {
            ...
            for (const root of upwardRoots(parent))
    ...
    return ProjectedMaterial = _classThis;
})();
export { ProjectedMaterial };
//# sourceMappingURL=ProjectedMaterial.js.map