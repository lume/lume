 ...
 */
let PointsMaterial = (() => {
    let _classDecorators = [element('lume-points-material', autoDefineElements)];
    ...
    var PointsMaterial = class extends _classSuper {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
            _texture_decorators = [stringAttribute];
            _sizeAttenuation_decorators = [booleanAttribute];
            _pointSize_decorators = [numberAttribute];
            ...
            PointsMaterial = _classThis = _classDescriptor.value;
    ...
    return PointsMaterial = _classThis;
})();
