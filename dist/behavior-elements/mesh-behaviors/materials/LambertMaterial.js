 ...
 */
let LambertMaterial = (() => {
    let _classDecorators = [element('lume-lambert-material', autoDefineElements)];
    ...
    var LambertMaterial = class extends _classSuper {
        ...
        static {
            ...
            LambertMaterial = _classThis = _classDescriptor.value;
    ...
    return LambertMaterial = _classThis;
})();
