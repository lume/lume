...
let BasicMaterialBehavior = (() => {
    let _classDecorators = [element('basic-material', autoDefineElements)];
    ...
    var BasicMaterialBehavior = class extends _classSuper {
        ...
        static {
            ...
            BasicMaterialBehavior = _classThis = _classDescriptor.value;
    ...
    return BasicMaterialBehavior = _classThis;
})();
