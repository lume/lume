 ...
 */
let TorusGeometry = (() => {
    let _classDecorators = [element('lume-torus-geometry', autoDefineElements)];
    ...
    var TorusGeometry = class extends _classSuper {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
            _tubeThickness_decorators = [numberAttribute];
            _radialSegments_decorators = [numberAttribute];
            _tubularSegments_decorators = [numberAttribute];
            _arc_decorators = [numberAttribute];
            ...
            TorusGeometry = _classThis = _classDescriptor.value;
    ...
    return TorusGeometry = _classThis;
})();
