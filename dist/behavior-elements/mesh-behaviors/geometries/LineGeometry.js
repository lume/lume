 ...
 */
let LineGeometry = (() => {
    let _classDecorators = [element('lume-line-geometry', autoDefineElements)];
    ...
    var LineGeometry = class extends _classSuper {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
            _get_points_decorators = [attribute];
            ...
            LineGeometry = _classThis = _classDescriptor.value;
    ...
    return LineGeometry = _classThis;
})();
export { LineGeometry };
