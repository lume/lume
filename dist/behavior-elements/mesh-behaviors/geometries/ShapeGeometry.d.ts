...
export type ShapeGeometryAttributes = 'shape' | 'curveSegments' | 'bevel' | 'bevelSegments' | 'bevelThickness' | 'centerGeometry' | 'fitment';
/**
 * @class ShapeGeometry -
 *
 ...
 * @element lume-shape-geometry
 */
export declare class ShapeGeometry extends GeometryBehaviorEl {
    #private;
    /**
    ...
    _createComponent(): ExtrudeGeometry | ThreeShapeGeometry;
