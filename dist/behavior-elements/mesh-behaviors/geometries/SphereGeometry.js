 ...
 */
let SphereGeometry = (() => {
    let _classDecorators = [element('lume-sphere-geometry', autoDefineElements)];
    ...
    var SphereGeometry = class extends _classSuper {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
            _horizontalSegments_decorators = [numberAttribute];
            _verticalSegments_decorators = [numberAttribute];
            ...
            SphereGeometry = _classThis = _classDescriptor.value;
        ...
        _createComponent() {
            return new ThreeSphereGeometry(this.composedParent.calculatedSize.x / 2, this.horizontalSegments, this.verticalSegments);
        }
        constructor() {
            super(...arguments);
    ...
    return SphereGeometry = _classThis;
})();
