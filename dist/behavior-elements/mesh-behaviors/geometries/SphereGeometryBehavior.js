...
let SphereGeometryBehavior = (() => {
    let _classDecorators = [element('sphere-geometry', autoDefineElements)];
    ...
    var SphereGeometryBehavior = class extends _classSuper {
        ...
        _createComponent() {
            return new SphereGeometry(this.composedParent.calculatedSize.x / 2, this.horizontalSegments, this.verticalSegments);
        }
        constructor() {
            super(...arguments);
