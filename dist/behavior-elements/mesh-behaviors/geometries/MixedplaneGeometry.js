 ...
 * @element lume-mixedplane-geometry
 */
let MixedplaneGeometry = (() => {
    let _classDecorators = [element('lume-mixedplane-geometry', autoDefineElements)];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    let _classSuper = GeometryBehaviorEl;
    var MixedplaneGeometry = class extends _classSuper {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
            __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
            MixedplaneGeometry = _classThis = _classDescriptor.value;
    ...
    return MixedplaneGeometry = _classThis;
})();
export { MixedplaneGeometry };
//# sourceMappingURL=MixedplaneGeometry.js.map