...
let RoundedRectangleGeometryBehavior = (() => {
    let _classDecorators = [element('rounded-rectangle-geometry', autoDefineElements)];
    ...
    var RoundedRectangleGeometryBehavior = class extends _classSuper {
        ...
        static {
            ...
            _cornerRadius_decorators = [attribute({ from: Number })];
            _thickness_decorators = [attribute({ from: Number })];
            _get_quadraticCorners_decorators = [attribute];
