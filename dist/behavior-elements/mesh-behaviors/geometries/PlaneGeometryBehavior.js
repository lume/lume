...
let PlaneGeometryBehavior = (() => {
    let _classDecorators = [element('plane-geometry', autoDefineElements)];
    ...
    var PlaneGeometryBehavior = class extends _classSuper {
        ...
        _createComponent() {
            return new PlaneGeometry(this.composedParent.calculatedSize.x, this.composedParent.calculatedSize.y, this.widthSegments, this.heightSegments);
        }
        constructor() {
            super(...arguments);
