 ...
 */
let PlaneGeometry = (() => {
    let _classDecorators = [element('lume-plane-geometry', autoDefineElements)];
    ...
    var PlaneGeometry = class extends _classSuper {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
            _widthSegments_decorators = [numberAttribute];
            _heightSegments_decorators = [numberAttribute];
            ...
            PlaneGeometry = _classThis = _classDescriptor.value;
        ...
        _createComponent() {
            return new ThreePlaneGeometry(this.composedParent.calculatedSize.x, this.composedParent.calculatedSize.y, this.widthSegments, this.heightSegments);
        }
        constructor() {
            super(...arguments);
    ...
    return PlaneGeometry = _classThis;
})();
