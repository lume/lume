 ...
 * @element lume-roundedrect-geometry
 */
let RoundedrectGeometry = (() => {
    let _classDecorators = [element('lume-roundedrect-geometry', autoDefineElements)];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    let _classSuper = GeometryBehaviorEl;
    ...
    let _quadraticCorners_decorators;
    let _quadraticCorners_initializers = [];
    let _quadraticCorners_extraInitializers = [];
    var RoundedrectGeometry = class extends _classSuper {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
            _cornerRadius_decorators = [numberAttribute];
            _thickness_decorators = [numberAttribute];
            _quadraticCorners_decorators = [booleanAttribute];
            ...
            __esDecorate(null, null, _quadraticCorners_decorators, { kind: "field", name: "quadraticCorners", static: false, private: false, access: { has: obj => "quadraticCorners" in obj, get: obj => obj.quadraticCorners, set: (obj, value) => { obj.quadraticCorners = value; } }, metadata: _metadata }, _quadraticCorners_initializers, _quadraticCorners_extraInitializers);
            __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
            RoundedrectGeometry = _classThis = _classDescriptor.value;
            if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
            __runInitializers(_classThis, _classExtraInitializers);
        }
        cornerRadius = __runInitializers(this, _cornerRadius_initializers, 0);
        thickness = (__runInitializers(this, _cornerRadius_extraInitializers), __runInitializers(this, _thickness_initializers, 0));
        quadraticCorners = (__runInitializers(this, _thickness_extraInitializers), __runInitializers(this, _quadraticCorners_initializers, false));
        _createComponent() {
            let thickness = this.thickness;
            let geom;
            const roundedRectShape = new RoundedRectShape(0, 0, this.composedParent.calculatedSize.x, this.composedParent.calculatedSize.y, this.cornerRadius, this.quadraticCorners);
            if (thickness > 0) {
            ...
            geom.translate(-this.composedParent.calculatedSize.x / 2, -this.composedParent.calculatedSize.y / 2, -thickness / 2);
            return geom;
        }
        constructor() {
            super(...arguments);
            __runInitializers(this, _quadraticCorners_extraInitializers);
        }
    };
    return RoundedrectGeometry = _classThis;
})();
export { RoundedrectGeometry };
...
//# sourceMappingURL=RoundedrectGeometry.js.map