 ...
 */
let PlyGeometry = (() => {
    let _classDecorators = [element('lume-ply-geometry', autoDefineElements)];
    ...
    var PlyGeometry = class extends _classSuper {
        ...
        static {
            ...
            PlyGeometry = _classThis = _classDescriptor.value;
        ...
        #onError(error) {
            const message = `Failed to load ${this.composedParent.tagName.toLowerCase()} with src "${this.src}". See the following error.`;
    ...
    return PlyGeometry = _classThis;
})();
export { PlyGeometry };
//# sourceMappingURL=PlyGeometry.js.map