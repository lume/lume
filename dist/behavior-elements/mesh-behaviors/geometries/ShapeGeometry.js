 ...
 */
let ShapeGeometry = (() => {
    let _classDecorators = [element('lume-shape-geometry', autoDefineElements)];
    ...
    var ShapeGeometry = class extends _classSuper {
        ...
        static {
            ...
            ShapeGeometry = _classThis = _classDescriptor.value;
            if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
            __runInitializers(_classThis, _classExtraInitializers);
        }
        #shape = (__runInitializers(this, _instanceExtraInitializers), defaultShape.clone());
        /**
        ...
        _createComponent() {
            ...
            if (this.fitment === 'contain') {
                ...
                if (!(shapeSizeX <= this.composedParent.calculatedSize.x && shapeSizeY <= this.composedParent.calculatedSize.y)) {
                    // tall
                    if (shapeAspect < sizeAspect)
                        geometry.scale(1 / scaleY, 1 / scaleY, 1);
                    // wide (or equal)
    ...
    return ShapeGeometry = _classThis;
})();
