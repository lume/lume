...
let PhysicalMaterialBehavior = (() => {
    ...
    var PhysicalMaterialBehavior = class extends _classSuper {
        ...
        static {
            ...
            __esDecorate(null, null, _clearcoat_decorators, { kind: "field", name: "clearcoat", static: false, private: false, access: { has: obj => "clearcoat" in obj, get: obj => obj.clearcoat, set: (obj, value) => { obj.clearcoat = value; } }, metadata: _metadata }, _clearcoat_initializers, _instanceExtraInitializers);
            __esDecorate(null, null, _clearcoatRoughness_decorators, { kind: "field", name: "clearcoatRoughness", static: false, private: false, access: { has: obj => "clearcoatRoughness" in obj, get: obj => obj.clearcoatRoughness, set: (obj, value) => { obj.clearcoatRoughness = value; } }, metadata: _metadata }, _clearcoatRoughness_initializers, _instanceExtraInitializers);
            __esDecorate(null, null, _refractiveIndex_decorators, { kind: "field", name: "refractiveIndex", static: false, private: false, access: { has: obj => "refractiveIndex" in obj, get: obj => obj.refractiveIndex, set: (obj, value) => { obj.refractiveIndex = value; } }, metadata: _metadata }, _refractiveIndex_initializers, _instanceExtraInitializers);
            ...
            __esDecorate(null, null, _transmission_decorators, { kind: "field", name: "transmission", static: false, private: false, access: { has: obj => "transmission" in obj, get: obj => obj.transmission, set: (obj, value) => { obj.transmission = value; } }, metadata: _metadata }, _transmission_initializers, _instanceExtraInitializers);
            __esDecorate(null, null, _transmissionMap_decorators, { kind: "field", name: "transmissionMap", static: false, private: false, access: { has: obj => "transmissionMap" in obj, get: obj => obj.transmissionMap, set: (obj, value) => { obj.transmissionMap = value; } }, metadata: _metadata }, _transmissionMap_initializers, _instanceExtraInitializers);
        ...
        // WIP
        clearcoat = (__runInitializers(this, _instanceExtraInitializers), __runInitializers(this, _clearcoat_initializers, 0
        // clearcoatMap
        // clearcoatNormalMap
        ...
        // clearcoatNormalMap
        // clearcoatNormalScale
        clearcoatRoughness = __runInitializers(this, _clearcoatRoughness_initializers, 0
        // clearcoatRoughnessMap
        // defines
        );
        // clearcoatRoughnessMap
        // defines
        refractiveIndex = __runInitializers(this, _refractiveIndex_initializers, 1.5);
        reflectivity = __runInitializers(this, _reflectivity_initializers, 0.5
        ...
        // specularColor
        // specularColorMap
        transmission = __runInitializers(this, _transmission_initializers, 0);
        transmissionMap = __runInitializers(this, _transmissionMap_initializers, '');
        _createComponent() {
