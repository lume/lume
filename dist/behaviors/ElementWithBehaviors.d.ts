export type ElementWithBehaviors<BehaviorTypes, SelectedBehaviorProperties extends keyof BehaviorTypes> = WithStringValues<Partial<Pick<BehaviorTypes, SelectedBehaviorProperties>>>;
