...
exports.default = exports.Molecule = void 0;

var _Modifier = _interopRequireDefault(require("famous/src/core/Modifier"));

var _RenderNode = _interopRequireDefault(require("famous/src/core/RenderNode"));

var _TransitionableTransform = _interopRequireDefault(require("famous/src/transitions/TransitionableTransform"));

var _EventHandler = _interopRequireDefault(require("famous/src/core/EventHandler"));
 ...
 */
class Molecule extends _RenderNode.default {
  /**
  ...
  constructor(initialOptions) {
    super(); // "private" stuff. Not really, but regard it like so. For example, if
    ...
    this._ = {
      options: {},
      // set and get with this.options
      defaultOptions: {} // Add default values for this Molecule
    ...
    (0, _utils.simpleExtend)(this._.defaultOptions, {
      align: [0.5, 0.5],
      origin: [0.5, 0.5],
      transform: new _TransitionableTransform.default(),
      handler: new _EventHandler.default()
  ...
  setOptions(newOptions) {
    ...
    for (const prop in newOptions) {
      ...
      if (_Modifier.default.prototype['' + prop + 'From']) {
  ...
  resetOptions() {
    this.modifier = new _Modifier.default();
