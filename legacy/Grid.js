 ...
 * @extends Molecule
 */
class Grid extends _Molecule.default {
  /**
  ...
  constructor(columns, rows, size) {
    ...
    (0, _forLength.default)(this.columns * this.rows, this._createGridCell.bind(this));
  }
  /**
  ...
  _createGridCell(index) {
    ...
    const mod = new _Modifier.default({
      align: [0, 0],
      origin: [0, 0],
      size: cellSize ? [cellSize[0], cellSize[1]] : [undefined, undefined],
      transform: _Transform.default.translate(column * cellSize[0], row * cellSize[1], 0)
    });
    const mod2 = new _Modifier.default({
  ...
  setChildren(children) {
    (0, _forLength.default)(this.columns * this.rows, function (index) {
