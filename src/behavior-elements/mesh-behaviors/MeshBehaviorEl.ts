...
abstract class MeshBehaviorEl extends RenderableBehaviorEl {
	/**
	 * @property {Mesh | Points | InstancedMesh | Line | null} composedParent
	 */
	declare readonly composedParent: Mesh | Points | InstancedMesh | Line | null
	 ...
	 */
	override requiredParentType(): (typeof Mesh | typeof Points | typeof InstancedMesh | typeof Line)[] {
