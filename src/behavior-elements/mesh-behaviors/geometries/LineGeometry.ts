import {attribute, booleanAttribute, stringAttribute, element, type ElementAttributes} from '@lume/element'
...
export type LineGeometryAttributes = 'points' | 'centerGeometry' | 'fitment'

/**
 * @class LineGeometryBehavior -
 *
 * Element: `<lume-line-geometry>`
 *
 ...
 * [`<lume-basicline-material>`](../materials/LineBasicMaterial.md).
 *
 ...
 * @element lume-line-geometry
 */
@element('lume-line-geometry', autoDefineElements)
export class LineGeometry extends GeometryBehaviorEl {
	#points: number[] = []
...
declare module 'solid-js' {
	namespace JSX {
		interface IntrinsicElements {
			'lume-line-geometry': ElementAttributes<LineGeometry, LineGeometryAttributes>
		}
	}
}
...
declare global {
	interface HTMLElementTagNameMap {
		'lume-line-geometry': LineGeometry
	}
}
