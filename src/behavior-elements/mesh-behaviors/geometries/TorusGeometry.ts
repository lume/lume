...
import {TorusGeometry as ThreeTorusGeometry} from 'three/src/geometries/TorusGeometry.js'
import {GeometryBehaviorEl} from './GeometryBehaviorEl.js'
import {toRadians} from '../../../core/utils/index.js'
import {autoDefineElements} from '../../../LumeConfig.js'

export type TorusGeometryAttributes = 'tubeThickness' | 'radialSegments' | 'tubularSegments' | 'arc'

/**
 * @class TorusGeometryBehavior
 *
 * Element: `<lume-torus-geometry>`
 *
 ...
 */
export
@element('lume-torus-geometry', autoDefineElements)
class TorusGeometry extends GeometryBehaviorEl {
	 ...
	 */
	@numberAttribute tubeThickness = 0.1
	 ...
	 * donut tube.
	 */
	@numberAttribute radialSegments = 16
	 ...
	 */
	@numberAttribute tubularSegments = 32
	 ...
	 * shape.
	 */
	@numberAttribute arc = 360

	override _createComponent() {
		const outerDiameter = this.composedParent!.calculatedSize.x
		...
		return new ThreeTorusGeometry(radius, literalThickness, radialSegments, tubularSegments, toRadians(arc))
	}
}
...
declare module 'solid-js' {
	namespace JSX {
		interface IntrinsicElements {
			'lume-torus-geometry': ElementAttributes<TorusGeometry, TorusGeometryAttributes>
		}
	}
}
...
declare global {
	interface HTMLElementTagNameMap {
		'lume-torus-geometry': TorusGeometry
	}
}
