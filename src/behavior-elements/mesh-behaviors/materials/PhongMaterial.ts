...
import {numberAttribute, stringAttribute, booleanAttribute, element, type ElementAttributes} from '@lume/element'
import {MaterialBehaviorEl, type MaterialBehaviorElAttributes} from './MaterialBehaviorEl.js'
import {autoDefineElements} from '../../../LumeConfig.js'

export type PhongMaterialAttributes =
	| MaterialBehaviorElAttributes
	| 'alphaMap'
	| 'aoMap'
	| 'aoMapIntensity'
	| 'bumpMap'
 ...
 */
export
@element('lume-phong-material', autoDefineElements)
class PhongMaterial extends MaterialBehaviorEl {
	...
	@stringAttribute get emissive(): string | number {
	...
	@numberAttribute emissiveIntensity = 1
	@stringAttribute envMap = ''
	@booleanAttribute flatShading = false
	@stringAttribute lightMap = ''
	@numberAttribute lightMapIntensity = 1
	@stringAttribute texture = '' // map
	@stringAttribute normalMap = ''
	// normalMapType
	@numberAttribute normalScale = 1
	@numberAttribute reflectivity = 1
	@stringAttribute specularMap = ''

	@stringAttribute get specular(): string | number {
