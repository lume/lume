...
class MaterialBehavior extends GeometryOrMaterialBehavior {
	...
	override connectedCallback() {
		...
		this.createEffect(() => {
			...
			mat.opacity = this.parentElement!.opacity * this.materialOpacity
