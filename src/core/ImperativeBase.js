...
export function initImperativeBase() {
    ...
    ImperativeBase = Mixin(Base =>
        Class('ImperativeBase').extends(
            Transformable.mixin(Base),
                ...
                return {
                    ...
                    possiblyLoadThree(child) {
                        ...
                        if (instanceOf(child, Node)) {
                            console.log(
                                '     >> LOAD THREE',
                                Protected(child)._renderParent.constructor.name,
                    ...
                    childComposedCallback(child, connectionType) {
                        ...
                        if (instanceOf(child, ImperativeBase)) {
                            console.log(
                                ' ------------------ CHILD COMPOSED',
                                Protected(child)._composedParent.constructor.name +
                                    '#' +
                                    Protected(child)._composedParent.id,
