            ...
            return {
                ...
                protected: {
                    ...
                    _updateCameraPerspective() {
                        ...
                        Public(this).threeCamera.fov =
                            (180 * (2 * Math.atan(Public(this).calculatedSize.y / 2 / perspective))) / Math.PI
                        Public(this).threeCamera.position.z = perspective
                    },

                    _updateCameraAspect() {
                        Public(this).threeCamera.aspect =
                            Public(this).calculatedSize.x / Public(this).calculatedSize.y || 1
                    },
                    ...
                    _loadCSS() {
                        ...
                        setTimeout(() => {
                            console.log(
                                [].map.call(Public(this).children, n => [n.constructor.name, n.parent, n.position])
                            )
                        }, 1000)
                    },
