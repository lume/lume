...
var FrameLoop = function(options) {
  if (!options) options = {};

  this._FPS = 60;
  this._FRAME_DURATION = 1000 / this._FPS;
  this._THRESHOLD = this._FRAME_DURATION * 0.5;  // browser overhead
...
FrameLoop.prototype.queueFrame = function() {
 ...
 */
FrameLoop.prototype.timeOk = function() {
 ...
 */
FrameLoop.prototype.blockFor = function(time) {
