// Forked from three@r139/examples/jsm/loaders/ColladaLoader.js to slim down the imports.
import {ClampToEdgeWrapping, DoubleSide, FrontSide, RepeatWrapping, sRGBEncoding} from 'three/src/constants.js'
